...
<body>
  <div class="d-flex flex-nowrap">
    ...
    <!-- Main Content -->
    <div class="main">
      <h2 class="mb-4">Manage Fishers</h2>
          ...
          <?php foreach ($fisherList as $row): ?>
            <tr>
              ...
              <td>
                ...
                <a href="delete_fisher.php?id=<?= $row['fisher_id'] ?>" onclick="return confirm('Are you sure?')"
          ...
          <div class="modal-dialog modal-dialog-centered">
            <form action="update_fisher.php" method="POST" class="modal-content">
              ...
              <div class="modal-body">
                ...
                <input type="text" name="location" class="form-control mb-3" value="<?= $row['location'] ?>">
              </div>
